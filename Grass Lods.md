...
- If you modlist is a bit more complicated, then you will need to create a backup of your modlist and then use the [Unoffical Skyrim Downloader](https://www.nexusmods.com/skyrimspecialedition/mods/61756) to create a **BEST OF BOTH WORLDS** downgraded version of Skyrim. A fully downgraded version **WILL NOT** work with this. As before, I **highly** recommend creating a seperate profile in MO2 which just contains your grass and landscape editing mods alongside 1.5.97 compatible engine fixing plugins (Engine fixes, bug fixes, scrambled bugs etc...)
